...
export default function LandingPageWhite() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-[30px] w-full text-sans">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
                {[
                  ...
                  <div key={item.n} className="text-center group motion-safe:animate-fadeIn">
                    <div className="w-20 h-20 bg-red-900 rounded-full flex items-center justify-center mx-auto mb-6 transform transition-transform duration-300 group-hover:scale-110 shadow-xl">
                      <span className="text-2xl text-white-900 font-bold">{item.n}</span>
                    </div>
